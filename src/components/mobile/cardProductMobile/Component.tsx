    ...
    >
      ...
      <div className="flex flex-col justify-between min-h-[80px] w-full">
        <div className="flex items-center justify-between w-full">
          <div>
            <p className="text-[13px] text-primary-4">PROMO</p>
            <p className="text-[10px] font-medium text-black-3">Shop Name</p>
          </div>
          <HeartFilledIcon />
        </div>
        <p className="text-[13px] font-medium text-black-4">
          {/* box-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.25); */}
          Cashback{' '}
          <span className="text-[16px] font-bold drop-shadow-lg">10%</span>
        </p>
        <div className="border border-primary-4 rounded-[3px] flex items-center gap-1 justify-center w-fit px-1">
