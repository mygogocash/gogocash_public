...
export default function Component({
  ...
  return (
    <Form.Field name={name} className="relative">
      <div
        className="flex items-center justify-between px-3  border border-[var(--grey-1)] rounded-[8px] bg-white h-[52px]"
        onClick={() => onOpenChange?.(!open)}
      >
        <p className="text-[14px] md:text-[24px] text-[var(--black-4)]">
