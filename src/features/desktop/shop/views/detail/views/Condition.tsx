    ...
    <div className="md:my-[64px] my-10 mx-5 md:mx-[40px] overflow-y-auto ">
      ...
      <div className="my-[48px]">
        <BadgeList
          list={[
            {
              icon: <CoinsIcon size={30} className="stroke-[var(--black-5)]" />,
              title: '9.98%',
            ...
            {
              icon: (
                <WalletIcon size={30} className="stroke-[var(--black-5)]" />
              ),
              title: '2 Days',
      ...
      <div className="space-y-5">
        <div>
          <h1 className="font-bold text-[20px] md:text-[24px] text-[var(--black-5)]">
            Featured Products
          </h1>
