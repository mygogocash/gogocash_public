...
const Component = () => {
  ...
  return (
    <div className="p-5 space-y-5">
      <p className="text-[20px] font-medium text-[var(--black-6)]">
        Wallet History
      </p>
      <div
        onClick={() => {
      ...
      >
        ...
        <div className="w-full">
          <div className="flex items-center justify-between w-full">
            <p className="text-[16px] font-medium text-[var(--black-6)]">sss</p>
          ...
          <p className="text-[var(--black-6)] text-[10px] capitalize">
            complete
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="w-full">
          <div className="flex items-center justify-between w-full">
            <p className="text-[16px] font-medium text-[var(--black-6)]">sss</p>
            <p className="text-[20px] font-medium text-[var(--primary-4)]">
              +$20
            </p>
          </div>
          <p className="text-gray-400 text-[10px]">Earn Cashback</p>
